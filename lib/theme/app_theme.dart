...
/// A class that contains all theme configurations for the medical cardiac assessment application.
/// Implements Clinical Precision Minimalism design philosophy with Medical Trust Palette.
class AppTheme {
  AppTheme._();

  // Medical Trust Palette - Color specifications optimized for clinical environments
  static const Color primaryLight = Color(0xFF2E5BDA); // Deep medical blue
  static const Color primaryVariantLight =
      Color(0xFF1E3A8A); // Darker blue variant
  static const Color secondaryLight = Color(0xFF00A86B); // Medical green
  static const Color secondaryVariantLight =
      Color(0xFF059669); // Darker green variant
  static const Color backgroundLight = Color(0xFFFFFFFF); // Pure white
  static const Color surfaceLight = Color(0xFFFAFBFC); // Subtle off-white
  static const Color errorLight = Color(0xFFD32F2F); // Clinical red
  ...
  // Dark theme colors for clinical environments with reduced lighting
  ...
  static const Color backgroundDark = Color(0xFF0F172A); // Deep clinical dark
  ...
  // Medical text hierarchy colors
  static const Color textPrimaryLight =
      Color(0xFF1A1A1A); // Maximum readability
  ...
  /// Light theme optimized for clinical environments and diagnostic clarity
  static ThemeData lightTheme = ThemeData(
    ...
    // Clinical AppBar with medical authority
    ...
    // Medical card design with subtle elevation
    cardTheme: CardTheme(
      color: cardLight,
      elevation: 2.0,
      shadowColor: shadowLight,
    ...
    // Clinical navigation optimized for one-handed use
    ...
    // Contextual floating action for recording controls
    ...
    // Medical button styling with clinical precision
    ...
    // Medical typography with Inter font family
    textTheme: _buildTextTheme(isLight: true),

    // Clinical form inputs with high contrast
    ...
    // Dialog styling for clinical alerts
  ...
  /// Dark theme optimized for low-light clinical environments
  ...
  /// Helper method to build medical typography with Inter and JetBrains Mono fonts
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      // Display styles for large medical headings
  ...
  /// Get monospace text style for diagnostic data display
